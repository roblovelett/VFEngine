...
namespace ScriptableObjects.Atoms.Transform.Pairs
{
    ...
    public struct TransformPair : IPair<UnityEngine.Transform>
    {
        ...
        [SerializeField] private UnityEngine.Transform _item1;
        [SerializeField] private UnityEngine.Transform _item2;

        public void Deconstruct(out UnityEngine.Transform item1, out UnityEngine.Transform item2)
        {
            item1 = Item1;
            item2 = Item2;
        }
