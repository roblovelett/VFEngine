using UnityEngine;
using VFEngine.Platformer.Physics.Character.ScriptableObjects;
...
namespace VFEngine.Platformer.Physics.Character
{
	public class Controller : MonoBehaviour
	{
		...
		//"It's usually good practice to build all your characters facing right. If that's not the case of this character, select Left instead.",MoreMountains.Tools.MMInformationAttribute.InformationType.Info,false)]
		public FacingDirections InitialFacingDirection = FacingDirections.Right;

		/// the direction the character will face on spawn
		//"Here you can force a direction the character should face when spawning. If set to default, it'll match your model's initial facing direction.",MoreMountains.Tools.MMInformationAttribute.InformationType.Info,false)]
