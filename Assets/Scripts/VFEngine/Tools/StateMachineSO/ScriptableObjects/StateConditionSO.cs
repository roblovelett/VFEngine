...
namespace VFEngine.Tools.StateMachineSO.ScriptableObjects
{
	public abstract class StateConditionSO : ScriptableObject
	{
		...
		/// </summary>
		internal StateCondition GetCondition(VFEngine.Tools.StateMachineSO.StateMachine stateMachine, bool expectedResult, Dictionary<ScriptableObject, object> createdInstances)
		{
