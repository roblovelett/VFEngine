...
namespace VFEngine.Tools.StateMachine.ScriptableObjects.Menu
{
    ...
    internal static class EditorText
    {
        ...
        private static readonly string DefaultPath = $"{VFEnginePath}Tools/StateMachine/ScriptableObjects/";
        ...
        private static readonly string MenuPath = $"{DefaultPath}/Menu/";
        ...
        internal static readonly string UxmlPath = $"{MenuPath}{TransitionTableWindow}.uxml";
        internal static readonly string UssPath = $"{MenuPath}{TransitionTableWindow}.uss";
        internal static readonly string AddTransitionButton = $"Add {Transition}";
        internal static readonly string ConditionsLabel = $"{Condition}s";
